...
import { Home, Users, Users2, Building2, FileText, Wrench, Settings, Database, Menu, LogOut, LayoutList, ClipboardList, History, X, Zap, Bell, CalendarCheck } from 'lucide-react'
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Loại phòng', href: '/admin/room-types', icon: LayoutList },
    { name: 'Đăng ký phòng', href: '/admin/registrations', icon: ClipboardList },
    { name: 'Lịch hẹn xem phòng', href: '/admin/appointments', icon: CalendarCheck },
    ...
    { name: 'Duyệt chỉ số', href: '/admin/meter-readings', icon: Zap },
    { name: 'Sự cố', href: '/admin/incidents', icon: Wrench },
    { name: 'Tài khoản', href: '/admin/users', icon: Users2 },
    { name: 'Chatbot KB', href: '/admin/knowledge', icon: Database },
    { name: 'Nhật ký HĐ', href: '/admin/audit-logs', icon: History },
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-5 h-16 border-b border-white/8">
        ...
        <div className="min-w-0">
          <p className="text-sm font-bold font-sans text-white truncate">Quản lý KTX</p>
      ...
      <div className="px-3 py-4 border-t border-white/8">
        <button
          ...
          className="sidebar-nav-item text-danger-300 hover:text-danger-200 hover:bg-danger-500/10 w-full"
        >
        ...
        <header className="sticky top-0 z-30 flex h-header items-center gap-4 border-b border-surface-200/60 bg-white/80 backdrop-blur-md px-4 lg:px-6">
          ...
          <div className="flex flex-1 items-center justify-between">
            <div className="hidden sm:block">
              <h1 className="text-base font-bold font-sans text-navy-700">Quản lý Ký túc xá</h1>
            </div>
            <div className="flex items-center gap-2">
              <NotificationDropdown href="/admin/notifications" />
              <div className="flex items-center gap-2.5 pl-2 ml-2 border-l border-surface-200">
                <div className="w-8 h-8 rounded-xl bg-navy-600 flex items-center justify-center text-white text-xs font-bold font-sans">
