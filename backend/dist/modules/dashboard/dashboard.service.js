...
class DashboardService {
    async getDashboardStats() {
        ...
        const [totalRooms, occupiedRooms, availableRooms, totalStudents, activeContracts, totalRevenueThisMonth, totalRevenueLastMonth, pendingInvoicesCount, pendingInvoicesAmount, openTicketsCount, collectedThisMonth, outstandingAmount, newStudentsThisMonth] = await Promise.all([
            prisma.room.count(),
        ...
        const [revenueByRoomType, studentsByFaculty, studentsByYear, incidentsByCategory, paymentsByMethod, revenueTrend, incidentsStats, resolvedIncidents] = await Promise.all([
